(function (r) {
  ...
  gulp.task('scriptsAllJs', function() {
    return gulp.src(['./js/vendor/jquery/dist/jquery.min.js', './js/vendor/fancybox/dist/jquery.fancybox.min.js', './js/vendor/slick-carousel/slick/slick.min.js', './js/vendor/jquery.inputmask/dist/jquery.inputmask.min.js', './js/vendor/jquery-validation/dist/jquery.validate.min.js', './js/main.min.js'])
      .pipe(uncomment({removeEmptyLines: true}))
